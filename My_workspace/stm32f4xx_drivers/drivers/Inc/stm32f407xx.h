...
#define PERRPH_BASEADDR				0x40000000U
#define APB1PERIPH_BASEADDR			PERRPH_BASEADDR
...
typedef struct{
	...
	__vo uint32_t AHB1RSTR;							/*RCC clock interrupt register*/
 ...
 *  This pointer, which belongs to the data type GPIO_RegDef_t, is used to store the base address of peripherals
 */
...
/*
 * Clock enable & disable macros for GPIO Peripheral
 */
...
/*
 * Clock disable macros for USARY peripheral
 */
